...
for(var i = 0; i < nations.length; i++){
    console.log("Šalis: " + nations[i].name + ", joje gyvena " + nations[i].pop + " mln. gyventojų. Valstybės plotas: " + nations[i].area + ", plotas tenkantis vienam gyventojui:" + ((nations[i].area*metrai)/nations[i].pop).toFixed(0))
}
